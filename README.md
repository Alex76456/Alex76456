...
* ### Welbex:
    ...
    таблица в формате SPA/сортировка и фильтрация

* ### Pultpage:

    https://github.com/Alex76456/pultpage

    верстка SPA/карусели/динамическое отображение товаров

* ### Яндекс. Практикум:

    https://github.com/Alex76456/yandex-reviewer

    код-ревью проекта от студента/javascript
